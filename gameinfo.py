...
#data retrieval --------------------------------------------------------------
day = '20211019' #change to last date in database via query
today = datetime.date.today().strftime('%Y%m%d')
gamenum = 0 #change to length of table via query

dates = pd.date_range(start = day, end = today).strftime('%Y%m%d').to_list()   #list of dates to get game info from
